...
# 305 "iotk_dat.spp"
    call iotk_write_begin(unit,iotk_toupper("REAL"),lattr,ierr=ierrl) 
# 307 "iotk_dat.spp"
  end if
!->
...
!-<
  if (qe_syntax) then
# 386 "iotk_dat.spp"
    call iotk_write_end(unit,iotk_toupper("REAL"),ierr=ierrl) 
# 388 "iotk_dat.spp"
    if(ierrl/=0) then
      call iotk_error_issue(ierrl,"iotk_write_dat",__FILE__,__LINE__)
# 389 "iotk_dat.spp"
...
!-<
    if (qe_syntax) then 
# 947 "iotk_dat.spp"
      call iotk_scan_end(unit,iotk_toupper("REAL"),ierr=ierrl2) 
# 949 "iotk_dat.spp"
       if(ierrl2/=0) then
...
# 1042 "iotk_dat.spp"
  ...
  call iotk_scan_begin(unit,iotk_toupper("REAL"),lattr,found=foundl,ierr=ierrl)
# 1045 "iotk_dat.spp"
  if(.not. foundl) goto 1
