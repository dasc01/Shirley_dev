...
! ======================================================================
  subroutine fermi_energy( nelec, nk, nbnd, wk, eigvalk, kT, smearing, ef , nspin)
! ======================================================================
  ...
  call mp_sum( wktot )
  wkfac = spfac / wktot
  nbndf = int(nelec/spfac)
  ef = sum(eigvalk(nbndf,:)*wk(:)*wkfac)/spfac
  call mp_sum(ef)
  ...
  write(stdout,'(4f)') ef*rytoev, def, nelecf, nelec
