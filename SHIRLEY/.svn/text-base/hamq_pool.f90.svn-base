...
! ---------------------------------------------------------------------- 
  ...
  call mp_bcast(nproc_per_pool, root)
...
! ---------------------------------------------------------------------- 
  ...
  use mp, only : mp_max, mp_sum, mp_scatter_size, mp_scatter_displ
...
! ---------------------------------------------------------------------- 
  ...
  ! this amount is nearly always not enough for the workspace
  integer :: memfac
  integer :: i, j
  ...
  contains
    ...
    abstol=PDLAMCH( context_cyclic, 'U')
