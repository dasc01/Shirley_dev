...
200  CALL errore ('haydockinit', 'reading inputpp namelist', ABS (ios) ) 
     ! 
  ...
  CALL mp_bcast( trace_tol,  ionode_id ) 
  CALL mp_bcast( ndim,  ionode_id ) 
  CALL mp_bcast( band_subset,  ionode_id ) 
  CALL mp_bcast( expand_kpts,  ionode_id ) 
  CALL mp_bcast( ecut_in,  ionode_id ) 
