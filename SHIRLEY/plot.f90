...
! ----------------------------------------------------------------------
  subroutine plotspec_bcast( plotspec, root )
! ----------------------------------------------------------------------
  ...
  call mp_bcast( plotspec%nplot, root )
  if( mpime /= root ) then
    allocate( plotspec%ink(2,plotspec%nplot) )
  endif
  call mp_bcast( plotspec%ink, root )

  end subroutine plotspec_bcast
  

! ----------------------------------------------------------------------
  subroutine plotspec_scatter( plotspec, root )
! ----------------------------------------------------------------------
