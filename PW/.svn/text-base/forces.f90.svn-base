...
!  REAL( DP ), ALLOCATABLE :: force_vcorr(:,:)
  ...
  write(stdout,*) 'forces --- starting time for forces:'
  ...
  write(stdout,*) 'forces --- nonlocal contribution:'
  call print_clock( 'forces' )
  !
  ...
  write(stdout,*) 'forces --- local contribution:'
  call print_clock( 'forces' )
  !
  ! ... The NLCC contribution
  !
  CALL force_cc( forcecc )
  write(stdout,*) 'forces --- NLCC contribution:'
  call print_clock( 'forces' )
  !
  ! ... The Hubbard contribution
  !
  IF ( lda_plus_u ) CALL force_hub( forceh )
  write(stdout,*) 'forces --- Hubbard contribution:'
  call print_clock( 'forces' )
  !
  ...
  write(stdout,*) 'forces --- ionic contribution:'
  call print_clock( 'forces' )
  !
  ...
  write(stdout,*) 'forces --- SCF contribution:'
  call print_clock( 'forces' )
