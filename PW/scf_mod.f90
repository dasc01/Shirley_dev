...
!DASb
  type (scf_type) :: dna  ! Neutral Atom density (NA)
  type (scf_type) :: vna  ! Hartree potential of atomic density  
  type (scf_type) :: drhoa ! Differnce of scf and NA rho
  type (scf_type) :: dvna  ! Hartree pot of drhoa  
!DASe
